...
export const Contactus = () => {
  return (
    <>
    <h4 className='text-info m-5'>contact us</h4>
    <Row className='d-flex align-item-center justify-content-center flex-col mb-4'>
        ...
        <img src="../../src/images/tourgroup.jpg" className='p-5  img-responsive img-fluied cardzoom' width="600px" height="500px"  alt="Contact img"  />
        </div>
